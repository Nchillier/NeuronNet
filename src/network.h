 ...
 */
    std::pair<size_t, double> degree(const size_t& i) const;
 ...
 */
    std::vector<std::pair<size_t, double> > neighbors(const size_t& i) const;
 ...
 */
    std::set<size_t> step(const std::vector<double>& noise);
